...
Public Class loadPurchase
    ...
    Private Sub PrintPageHandler(sender As Object, e As PrintPageEventArgs)
        ...
        Dim itemdesc As String = "Items".PadRight(30)
        Dim Pricedesc As String = "Price".PadRight(7)
        Dim qtydesc As String = "Qnt".PadRight(5)
        Dim amtdesc As String = "Total"
        ...
        For k As Integer = 0 To checkoutItems.DataGridView1.RowCount - 1
            ...
            item = checkoutItems.DataGridView1.Rows(k).Cells(1).Value.ToString.PadRight(30)
